  ...
  return (
    <div className={`relative mb-5 group ${className}`} id={id}>
      ...
      <input
        ...
        className="w-full bg-slate-950/30 text-slate-100 placeholder-slate-600 rounded-xl px-4 py-3.5 text-xs outline-none border transition-all duration-300 z-10"
        style={{
